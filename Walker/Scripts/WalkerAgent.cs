...
public class WalkerAgent : Agent
{
    ...
    public override void Initialize()
    {
        ...
        m_RayPerception = GetComponentInChildren<RayPerceptionSensorComponent3D>();
    ...
    void FixedUpdate()
    {
        ...
        var rayOutputs = RayPerceptionSensor
                .Perceive(m_RayPerception.GetRayPerceptionInput())
                .RayOutputs;
        if (rayOutputs != null)
        {
        ...
        // m_RayPerception.RayPerceptionOutput
        var lookAtTargetReward = target_visible;
